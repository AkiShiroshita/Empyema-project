...
dpc <- read_excel("data/kumamoto.xlsx",
                  sheet = "dpc")
oral <- read_excel("data/kumamoto.xlsx",
                   sheet = "oral")
iv <- read_excel("data/kumamoto.xlsx",
                 sheet = "iv")
gram <- read_excel("data/kumamoto.xlsx",
                   sheet = "gram")
culture <- read_excel("data/kumamoto.xlsx",
                      sheet = "culture")
lab <- read_excel("data/kumamoto.xlsx",
                  sheet = "lab")
